...
export default function LiveSilverPriceLiquidGlass() {
  const [silverData, setSilverData] = useState<SilverPriceData | null>(null)
  ...
  useEffect(() => {
    ...
    const interval = setInterval(fetchSilverPrice, 60000)
  ...
  const changeStatus = silverData.change > 0 ? 'positive' : silverData.change < 0 ? 'negative' : 'neutral'
  ...
  return (
    ...
    >
      <div className="liquid-glass-ticker-inner">
        ...
        <div className="ticker-indicator ticker-indicator-silver" />
        
        <span className="ticker-symbol">Silver</span>
        
        <div className="ticker-price-group">
          <span className="ticker-price">${silverData.price.toFixed(2)}</span>
          ...
          <div className={`ticker-change ${changeStatus}`}>
            ...
            <span className="ticker-percent">({silverData.change >= 0 ? '+' : ''}{silverData.changePercent.toFixed(1)}%)</span>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        .liquid-glass-ticker {
          ...
          border: ${!isLightTheme ? 'none' : '1px solid rgba(192, 192, 192, 0.18)'};
          box-shadow: ${!isLightTheme ? 'none' : `
            0 8px 32px 0 rgba(0, 0, 0, 0.37),
            inset 0 2px 4px 0 rgba(192, 192, 192, 0.2),
        ...
        .liquid-glass-ticker:hover {
          ...
          box-shadow: 
            ...
            inset 0 2px 6px 0 rgba(192, 192, 192, 0.3),
        ...
        .ticker-symbol {
          font-size: 16px;
          font-weight: 600;
          color: ${isLightTheme ? '#1C1C1C' : 'rgba(230, 230, 230, 0.9)'};
        ...
        .ticker-unit {
          font-size: 14px;
          font-weight: 500;
          color: ${isLightTheme ? 'rgba(28, 28, 28, 0.6)' : 'rgba(230, 230, 230, 0.7)'};
          white-space: nowrap;
        }
        ...
        .ticker-change.negative {
          background: ${isLightTheme ? 'rgba(107, 114, 128, 0.1)' : 'rgba(230, 230, 230, 0.25)'};
          color: ${isLightTheme ? '#6B7280' : 'rgba(230, 230, 230, 0.9)'};
          border: 1px solid ${isLightTheme ? 'rgba(107, 114, 128, 0.3)' : 'rgba(230, 230, 230, 0.3)'};
          font-weight: 600;
          backdrop-filter: blur(10px);
        }
