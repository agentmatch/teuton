...
export default function LandingPageOmega() {
  ...
  return (
    <div ref={scrollRef} className="relative" style={{ height: '100vh' }}>
      ...
      >
        ...
        <div
          ref={containerRef}
          className="relative w-full max-w-[1600px] h-[90vh] rounded-3xl mt-8 mx-2 mb-2 p-[1px]"
          style={{
            background: `linear-gradient(45deg, 
              #FFD700 0%, #FFA500 10%, #FFD700 20%, #B8860B 30%, 
              #FFD700 40%, #FFA500 50%, #FFD700 60%, #DAA520 70%, 
              #FFD700 80%, #FFA500 90%, #FFD700 100%)`,
            backgroundSize: '150% 150%',
            boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.8), 0 0 20px rgba(255, 215, 0, 0.3)'
          }}
        >
          {/* Inner container with mountain background */}
          <div 
            className="relative w-full h-full rounded-[23px] overflow-hidden bg-black"
          >
            ...
            <div className="absolute inset-0">
              ...
              <div 
                className="absolute inset-0"
                style={{
                  backgroundImage: `url('/images/pyramids2.png')`,
